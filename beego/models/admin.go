...
type Admin struct {
	...
	Portrait  string `orm:"column(portrait);size(255)"`
	Telephone string `orm:"column(telephone);size(11)"`
...
// GetAdminByOpenID retrieves Admin by OpenID. Returns error if
// Id doesn't exist
func GetAdminByOpenID(openid string) (v *Admin, err error) {
	o := orm.NewOrm()
	v = &Admin{Openid: openid}
