const app = getApp(), api = require('../../utils/api.js'),
  ...
  allData = app.globalData, ui = require('../../utils/Interface.js')
Component({
  data: {
  ...
  methods: {
        ...
        utils.GET('getNav', function (res) {
          ...
          utils.GET('getInformation', function (res) {
            ...
            res.status == 0 ? t.setData({ info_list })
              : t.setData({ info_list: 'ErrorNetwork' }) & ui.showToast('错误:' + res.msg,1)
            wx.hideLoading()
    ...
    toLinks(e) {
      ...
      type == 1 ? wx.navigateTo({ url: url }) : wx.navigateTo({ url: ui.page.webview+'?url=' + url })
    },
  }
})