const api = require('api'), app = getApp(),
      globalData = app.globalData, 
      HEADER_X = "application/x-www-form-urlencoded",
      Header_J = 'application/json',
      jim = require('Jim.js'),
      ui = require('Interface.js')
var mthat;
      ...
      wx.request({
        ...
        success: function (e) {
          ...
          if (e.data.status == 0) { //登录成功
            ...
            globalData.login_code = data.login_code
            globalData.iconUrl = !data.portrait ? user.avatarUrl : data.portrait,
            globalData.is_super = data.is_super
            console.log('用户已登录:', e)
            jim.init(this)
